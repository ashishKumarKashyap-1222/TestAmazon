...
function Grid(props: PropsInterface): JSX.Element {
    ...
    const [columnsNew, updateColumns] = useState(setDefaultValue(columns));
    ...
    return (
        <div className="inte__tableWrap">
                    ...
                    <FlexLayout valign="center" spacing="loose">
                        <CheckBox
                            ...
                            checked={
                                ...
                                rows.filter((row: any) => row.enableCheck)
                                    .length
                            }
                        />
                        {massAction}
            ...
            <div className="inte__tableOverflow">
